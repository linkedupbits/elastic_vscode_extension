...
exports.assertTemplateIsWellFormed = assertTemplateIsWellFormed;
const VALID_VAR_TYPES = new Set(['string', 'multiline', 'boolean', 'number', 'stringArray', 'select']);
function assertField(field, where) {
    if (!field.key) {
 ...
 */
function assertTemplateIsWellFormed(template) {
...
//# sourceMappingURL=templateInvariants.js.map