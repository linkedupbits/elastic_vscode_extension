...
/**
 * Structural template for the Elastic `nginx` integration package at package version 2.3.2,
 * registered alongside `nginxPackageTemplate_3_2_1` (3.2.1) and `nginxPackageTemplate_2_0_0`
 * (2.0.0) so policies pinned to 2.3.2 get a structured editor too. Derived from the published
 * package registry snapshot: https://epr.elastic.co/epr/nginx/nginx-2.3.2.zip
 ...
 * Verified byte-for-byte structurally identical to 2.0.0 (manifest.yml and every data stream
 * manifest differ only in the `version:`/`format_version:` fields) - like 2.0.0, and unlike
 * 3.2.1, neither input declares a `condition` var.
 */
export const nginxPackageTemplate_2_3_2: PackageTemplate = {
  name: 'nginx',
  title: 'Nginx',
  version: '2.3.2',
  inputs: [
