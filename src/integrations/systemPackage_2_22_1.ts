...
/**
 * Structural template for the Elastic `system` integration package (package version
 * 2.22.1), derived from the package source of truth on GitHub:
 * https://github.com/elastic/integrations/tree/main/packages/system
