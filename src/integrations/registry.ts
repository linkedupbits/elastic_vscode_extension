...
export const integrationPackageTemplates: Record<string, PackageTemplate[]> = {
  system: [systemPackageTemplate_2_22_1, systemPackageTemplate_2_6_3, systemPackageTemplate_2_3_2],
  nginx: [nginxPackageTemplate_3_2_1, nginxPackageTemplate_2_0_0],
  apache: [apachePackageTemplate_2_0_0],
  apm: [apmPackageTemplate_9_0_3],
  ...
  postgresql: [postgresqlPackageTemplate_1_28_0],
};
